    ...
    <div class="body-wrapper-inner">
                <div class="container-fluid">
                    ...
                    <div class="row">
                                        ...
                                        <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/images/profile/user-3.jpg') }}" class="rounded-circle" width="40" alt="flexy" />
                                                            <div class="ms-3">
                                                ...
                                                <tr>
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/images/profile/user-5.jpg') }}" class="rounded-circle" width="40" alt="flexy" />
                                                            <div class="ms-3">
                                                ...
                                                <tr>
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/images/profile/user-6.jpg') }}" class="rounded-circle" width="40" alt="flexy" />
                                                            <div class="ms-3">
                                                                <h6 class="mb-0 fw-bolder">
                                                                    Christopher Jamil
                                                                </h6>
                                                ...
                                                <tr>
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/images/profile/user-7.jpg') }}" class="rounded-circle" width="40" alt="flexy" />
                                                            <div class="ms-3">
                                                ...
                                                <tr>
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('backend/images/profile/user-8.jpg') }}" class="rounded-circle" width="40" alt="flexy" />
                                                            <div class="ms-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                ...
                                <div class="comment-widgets scrollable mb-2 common-widget" style="height: 465px" data-simplebar="">
                                    ...
                                    <div class="d-flex flex-row comment-row border-bottom p-3 gap-3">
                                        <div>
                                            <span><img src="{{ asset('backend/images/profile/user-3.jpg') }}" class="rounded-circle" alt="user" width="50" /></span>
                                        </div>
                                        <div class="comment-text w-100">
                                            ...
                                            <div class="comment-footer mt-2">
                                                ...
                                                <span class="text-muted ms-auto fw-normal fs-2 d-block mt-2 text-end">April 14, 2025</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Comment Row -->
                                    <div class="d-flex flex-row comment-row border-bottom active p-3 gap-3">
                                        <div>
                                            <span><img src="{{ asset('backend/images/profile/user-5.jpg') }}" class="rounded-circle" alt="user" width="50" /></span>
                                        </div>
                          ...
                          ">April 14, 2025</span>
                                    ...
                                    <div class="d-flex flex-row comment-row border-bottom p-3 gap-3">
                                        <div>
                                            <span><img src="{{ asset('backend/images/profile/user-6.jpg') }}" class="rounded-circle" alt="user" width="50" /></span>
                                        </div>
                                        <div class="comment-text w-100">
                          ...
                          ">April 14, 2025</span>
                                    ...
                                    <div class="d-flex flex-row comment-row p-3 gap-3">
                                        <div>
                                            <span><img src="{{ asset('backend/images/profile/user-4.jpg') }}" class="rounded-circle" alt="user" width="50" /></span>
                                        </div>
                                        <div class="comment-text w-100">
                                            <h6 class="fw-medium">James Anderson</h6>
                                            <p class="mb-1 fs-2 text-muted">
                    ...
                    <div class="py-6 px-6 text-center">
                        <p class="mb-0 fs-4">Design and Developed by <a href="#" class="pe-1 text-primary text-decoration-underline">Wrappixel.com</a> Distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a></p>
                    </div>
                </div>
            </div>
@endsection
